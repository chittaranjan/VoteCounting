...
public class VotingServiceImpl implements VotingService {
    ...
    public VotingServiceImpl() {
        validBallots = new HashMap<>(); //Insertion order is not required
        currentVoteCount = new LinkedHashMap<>(); //Insertion of order of entries is required
        candidatesEliminatedAtCurrentRound = null;
        candidatesEliminated = new LinkedHashSet<>(); //Insertion Order of entries is required
    }
